...
def main(args=None):
    ...
    # ADD OPTIONS HERE ----------------------------
    options.net = 'data/cross.net.xml'
    options.dumps = 'data/edgeData.out,'
    options.measures = 'traveltime,'
    options.output = 'vis.png,'
    options.colorBarLabel = True
    options.widthMin = 10
    options.widthMax = 10
    # options.logColors = True
    # ---------------------------------------------
